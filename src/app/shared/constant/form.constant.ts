...
export const GENDER: ListItemInterface[] = [
    { id: "M", name: "Homme" },
    { id: "W", name: "Femme" }
];

export const IDNUMBER_NATURE: ListItemInterface[] = [
...
export const ESTABLISHMENT_NATURE: ListItemInterface[] = [
    { id: "RE", name: "Résidence" },
    { id: "HO", name: "Hotel" }
];

export const BEDROOM_TYPE: ListItemInterface[] = [
    { id: "CS", name: "Chambre régulière" },
    { id: "CF", name: "Chambre familiale" },
    { id: "S", name: "Suite" }
];

export const OCCUPATION_TYPE: ListItemInterface[] = [
    { id: "PA", name: "Passage" },
    { id: "NU", name: "Nuité" }
];

export const PHONE_TYPE: ListItemInterface[] = [
    { id: "PR", name: "Professional" },
    { id: "MO", name: "Mobile" }
];

export const NATIONALITY: ListItemInterface[] = [
