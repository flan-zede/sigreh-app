          ...
          <mat-card-content>
            ...
            <div class='d-flex'>
              <div class='flex-grow-1'>
                <div (click)='router.navigate([route.path + "/show", item.id])' >{{ item.departmentID }}</div>
              </div>
            </div>
          </mat-card-content>
        </mat-card>
...
export class SubprefectureComponent implements OnInit {

  items: Subprefecture[] = null;
  loader: boolean;
  route = ROUTE;
